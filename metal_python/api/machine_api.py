...
class MachineApi(object):
    ...
    def chassis_identify_led_off(self, id, description, body, **kwargs):  # noqa: E501
        """sends a power-off to the chassis identify LED  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.chassis_identify_led_off(id, description, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: identifier of the machine (required)
        :param str description: reason why the chassis identify LED has been turned off (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.chassis_identify_led_off_with_http_info(id, description, body, **kwargs)  # noqa: E501
        else:
            (data) = self.chassis_identify_led_off_with_http_info(id, description, body, **kwargs)  # noqa: E501
            return data

    def chassis_identify_led_off_with_http_info(self, id, description, body, **kwargs):  # noqa: E501
        """sends a power-off to the chassis identify LED  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.chassis_identify_led_off_with_http_info(id, description, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'description', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('description' not in params or
            ...
            raise ValueError("Missing the required parameter `description` when calling `chassis_identify_led_off`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
        ...
        return self.api_client.call_api(
            '/v1/machine/{id}/power/chassis-identify-led-off/{description}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def chassis_identify_led_on_0(self, id, description, body, **kwargs):  # noqa: E501
        """sends a power-on to the chassis identify LED  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.chassis_identify_led_on_0(id, description, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: identifier of the machine (required)
        :param str description: reason why the chassis identify LED has been turned on (required)
        :param V1EmptyBody body: (required)
        :return: V1MachineResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.chassis_identify_led_on_0_with_http_info(id, description, body, **kwargs)  # noqa: E501
        else:
            (data) = self.chassis_identify_led_on_0_with_http_info(id, description, body, **kwargs)  # noqa: E501
            return data

    def chassis_identify_led_on_0_with_http_info(self, id, description, body, **kwargs):  # noqa: E501
        """sends a power-on to the chassis identify LED  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.chassis_identify_led_on_0_with_http_info(id, description, body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method chassis_identify_led_on_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `chassis_identify_led_on_0`")  # noqa: E501
        # verify the required parameter 'description' is set
        if ('description' not in params or
                params['description'] is None):
            raise ValueError("Missing the required parameter `description` when calling `chassis_identify_led_on_0`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `chassis_identify_led_on_0`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/machine/{id}/power/chassis-identify-led-on/{description}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def ipmi_report(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param V1MachineIpmiReport body: (required)
    ...
    def machine_bios(self, id, body, **kwargs):  # noqa: E501
        """boots machine into BIOS on next reboot  # noqa: E501
    ...
    def wait_for_allocation(self, id, **kwargs):  # noqa: E501
        """wait for an allocation of this machine  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wait_for_allocation(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.wait_for_allocation_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.wait_for_allocation_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def wait_for_allocation_with_http_info(self, id, **kwargs):  # noqa: E501
        """wait for an allocation of this machine  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wait_for_allocation_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method wait_for_allocation" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `wait_for_allocation`")  # noqa: E501
