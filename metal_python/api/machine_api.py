...
class MachineApi(object):
    ...
    def add_provisioning_events(self, body, **kwargs):  # noqa: E501
        """adds machine provisioning events  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_provisioning_events(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V1MachineProvisioningEvents body: (required)
        :return: V1MachineRecentProvisioningEventsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.add_provisioning_events_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.add_provisioning_events_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def add_provisioning_events_with_http_info(self, body, **kwargs):  # noqa: E501
        """adds machine provisioning events  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_provisioning_events_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_provisioning_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_provisioning_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='V1MachineRecentProvisioningEventsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_machine(self, body, **kwargs):  # noqa: E501
        """updates a machine. if the machine was changed since this one was read, a conflict is returned  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_machine(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V1MachineUpdateRequest body: (required)
        :return: V1MachineResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_machine_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_machine_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def update_machine_with_http_info(self, body, **kwargs):  # noqa: E501
        """updates a machine. if the machine was changed since this one was read, a conflict is returned  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_machine_with_http_info(body, async_req=True)
        >>> result = thread.get()
