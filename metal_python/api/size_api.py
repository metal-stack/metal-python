...
class SizeApi(object):
    ...
    def list_size_reservations(self, body, **kwargs):  # noqa: E501
        """get all size reservations  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_size_reservations(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_size_reservations_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.list_size_reservations_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def list_size_reservations_with_http_info(self, body, **kwargs):  # noqa: E501
        """get all size reservations  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_size_reservations_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `list_size_reservations`")  # noqa: E501
