...
class V1FirewallCreateRequest(object):
    ...
    def __init__(self, description=None, filesystemlayoutid=None, ha=None, hostname=None, imageid=None, ips=None, name=None, networks=None, partitionid=None, placement_tags=None, projectid=None, sizeid=None, ssh_pub_keys=None, tags=None, user_data=None, uuid=None):  # noqa: E501
