...
class V1NetworkCreateRequest(object):
    ...
    def __init__(self, additional_announcable_cid_rs=None, description=None, destinationprefixes=None, id=None, labels=None, name=None, nat=None, parentnetworkid=None, partitionid=None, prefixes=None, privatesuper=None, projectid=None, shared=None, underlay=None, vrf=None, vrfshared=None):  # noqa: E501
