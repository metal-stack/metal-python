...
class V1MachineIPMIResponse(object):
    ...
    def __init__(self, allocation=None, bios=None, changed=None, created=None, description=None, events=None, hardware=None, id=None, ipmi=None, ledstate=None, liveliness=None, name=None, partition=None, rackid=None, size=None, state=None, tags=None, vpn=None):  # noqa: E501
    ...
    @property
    def vpn(self):
        """Gets the vpn of this V1MachineIPMIResponse.  # noqa: E501

        vpn connection info for machine  # noqa: E501

        :return: The vpn of this V1MachineIPMIResponse.  # noqa: E501
        :rtype: V1MachineVPN
        """
        return self._vpn
    ...
    @vpn.setter
    def vpn(self, vpn):
        """Sets the vpn of this V1MachineIPMIResponse.

        vpn connection info for machine  # noqa: E501

        :param vpn: The vpn of this V1MachineIPMIResponse.  # noqa: E501
        :type: V1MachineVPN
        """
