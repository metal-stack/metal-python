...
class V1NetworkAllocateRequest(object):
    ...
    def addressfamily(self):
        ...
        the addressfamily to allocate a child network. If not specified, the child network inherits the addressfamilies from the parent.  # noqa: E501
    ...
    def length(self):
        ...
        the bit lengths of the prefix to allocate, defaults to the default child prefix lengths of the parent network  # noqa: E501
