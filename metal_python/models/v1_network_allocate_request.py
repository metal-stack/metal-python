...
class V1NetworkAllocateRequest(object):
    ...
    def __init__(self, addressfamily=None, description=None, destinationprefixes=None, labels=None, length=None, name=None, nat=None, parentnetworkid=None, partitionid=None, projectid=None, shared=None):  # noqa: E501
    ...
    def addressfamily(self):
        """Gets the addressfamily of this V1NetworkAllocateRequest.  # noqa: E501

        the addressfamily to allocate a child network defaults. If not specified, the child network inherits the addressfamilies from the parent.  # noqa: E501

        :return: The addressfamily of this V1NetworkAllocateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def addressfamily(self, addressfamily):
        """Sets the addressfamily of this V1NetworkAllocateRequest.

        the addressfamily to allocate a child network defaults. If not specified, the child network inherits the addressfamilies from the parent.  # noqa: E501

        :param addressfamily: The addressfamily of this V1NetworkAllocateRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def length(self):
        """Gets the length of this V1NetworkAllocateRequest.  # noqa: E501

        the bitlen of the prefix to allocate, defaults to defaultchildprefixlength of super prefix  # noqa: E501

        :return: The length of this V1NetworkAllocateRequest.  # noqa: E501
        :rtype: dict(str, int)
        """
        return self._length
    ...
    def length(self, length):
        """Sets the length of this V1NetworkAllocateRequest.

        the bitlen of the prefix to allocate, defaults to defaultchildprefixlength of super prefix  # noqa: E501

        :param length: The length of this V1NetworkAllocateRequest.  # noqa: E501
        :type: dict(str, int)
        """
        if length is None:
    ...
    def parentnetworkid(self):
        """Gets the parentnetworkid of this V1NetworkAllocateRequest.  # noqa: E501

        the parent network from which this network should be allocated  # noqa: E501

        :return: The parentnetworkid of this V1NetworkAllocateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def parentnetworkid(self, parentnetworkid):
        """Sets the parentnetworkid of this V1NetworkAllocateRequest.

        the parent network from which this network should be allocated  # noqa: E501

        :param parentnetworkid: The parentnetworkid of this V1NetworkAllocateRequest.  # noqa: E501
        :type: str
        """
