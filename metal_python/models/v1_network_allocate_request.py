...
class V1NetworkAllocateRequest(object):
    ...
    def __init__(self, addressfamily=None, description=None, destinationprefixes=None, labels=None, length=None, name=None, nat=None, partitionid=None, projectid=None, shared=None):  # noqa: E501
