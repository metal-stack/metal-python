...
class V1NetworkImmutable(object):
    ...
    def __init__(self, additional_announcable_cid_rs=None, destinationprefixes=None, nat=None, parentnetworkid=None, prefixes=None, privatesuper=None, underlay=None, vrf=None, vrfshared=None):  # noqa: E501
