...
class V1PartitionResponse(object):
    ...
    def __init__(self, bootconfig=None, changed=None, created=None, description=None, dns_servers=None, id=None, labels=None, mgmtserviceaddress=None, name=None, ntp_servers=None):  # noqa: E501
