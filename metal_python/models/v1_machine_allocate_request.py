...
class V1MachineAllocateRequest(object):
    ...
    def __init__(self, description=None, hostname=None, imageid=None, ips=None, name=None, networks=None, partitionid=None, projectid=None, sizeid=None, ssh_pub_keys=None, tags=None, user_data=None, uuid=None):  # noqa: E501
