...
class V1MachineIPMI(object):
    ...
    def __init__(self, address=None, bmcversion=None, fru=None, interface=None, last_updated=None, mac=None, password=None, powermetric=None, powerstate=None, user=None):  # noqa: E501
