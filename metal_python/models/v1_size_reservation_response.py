...
class V1SizeReservationResponse(object):
    ...
    def __init__(self, partitionid=None, projectallocations=None, projectid=None, projectname=None, reservations=None, sizeid=None, tenant=None, usedreservations=None):  # noqa: E501
