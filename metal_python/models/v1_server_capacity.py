...
class V1ServerCapacity(object):
    ...
    def __init__(self, allocated=None, faulty=None, faultymachines=None, free=None, other=None, othermachines=None, phoned_home=None, reservations=None, size=None, total=None, unavailable=None, usedreservations=None, waiting=None):  # noqa: E501
