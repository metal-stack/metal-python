...
class V1NetworkUpdateRequest(object):
    ...
    def __init__(self, additional_announcable_cid_rs=None, description=None, destinationprefixes=None, id=None, labels=None, name=None, prefixes=None, shared=None):  # noqa: E501
