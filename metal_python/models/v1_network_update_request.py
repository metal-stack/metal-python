...
class V1NetworkUpdateRequest(object):
    ...
    def __init__(self, additional_announcable_cid_rs=None, defaultchildprefixlength=None, description=None, destinationprefixes=None, id=None, labels=None, name=None, prefixes=None, shared=None):  # noqa: E501
    ...
    def additional_announcable_cid_rs(self):
        """Gets the additional_announcable_cid_rs of this V1NetworkUpdateRequest.  # noqa: E501
        ...
        :return: The additional_announcable_cid_rs of this V1NetworkUpdateRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def additional_announcable_cid_rs(self, additional_announcable_cid_rs):
        """Sets the additional_announcable_cid_rs of this V1NetworkUpdateRequest.

        list of cidrs which are added to the route maps per tenant private network, these are typically pod- and service cidrs, can only be set for private super networks  # noqa: E501

        :param additional_announcable_cid_rs: The additional_announcable_cid_rs of this V1NetworkUpdateRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def defaultchildprefixlength(self):
        """Gets the defaultchildprefixlength of this V1NetworkUpdateRequest.  # noqa: E501

        if privatesuper, this defines the bitlen of child prefixes per addressfamily if not nil  # noqa: E501

        :return: The defaultchildprefixlength of this V1NetworkUpdateRequest.  # noqa: E501
        :rtype: dict(str, int)
        """
    ...
    def defaultchildprefixlength(self, defaultchildprefixlength):
        """Sets the defaultchildprefixlength of this V1NetworkUpdateRequest.

        if privatesuper, this defines the bitlen of child prefixes per addressfamily if not nil  # noqa: E501

        :param defaultchildprefixlength: The defaultchildprefixlength of this V1NetworkUpdateRequest.  # noqa: E501
        :type: dict(str, int)
        """
