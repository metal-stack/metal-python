...
class V1SwitchUpdateRequest(object):
    ...
    def __init__(self, console_command=None, description=None, id=None, management_ip=None, management_user=None, mode=None, name=None, os=None, rack_id=None):  # noqa: E501
    ...
    def console_command(self):
        """Gets the console_command of this V1SwitchUpdateRequest.  # noqa: E501

        command to access the console of the switch  # noqa: E501

        :return: The console_command of this V1SwitchUpdateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def console_command(self, console_command):
        """Sets the console_command of this V1SwitchUpdateRequest.

        command to access the console of the switch  # noqa: E501

        :param console_command: The console_command of this V1SwitchUpdateRequest.  # noqa: E501
        :type: str
        """
    ...
    def management_ip(self):
        """Gets the management_ip of this V1SwitchUpdateRequest.  # noqa: E501

        the ip address of the management interface of the switch  # noqa: E501

        :return: The management_ip of this V1SwitchUpdateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def management_ip(self, management_ip):
        """Sets the management_ip of this V1SwitchUpdateRequest.

        the ip address of the management interface of the switch  # noqa: E501

        :param management_ip: The management_ip of this V1SwitchUpdateRequest.  # noqa: E501
        :type: str
        """
    ...
    def management_user(self):
        """Gets the management_user of this V1SwitchUpdateRequest.  # noqa: E501

        the user to connect to the switch  # noqa: E501

        :return: The management_user of this V1SwitchUpdateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def management_user(self, management_user):
        """Sets the management_user of this V1SwitchUpdateRequest.

        the user to connect to the switch  # noqa: E501

        :param management_user: The management_user of this V1SwitchUpdateRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def os(self):
        """Gets the os of this V1SwitchUpdateRequest.  # noqa: E501

        the operating system the switch currently has  # noqa: E501

        :return: The os of this V1SwitchUpdateRequest.  # noqa: E501
        :rtype: V1SwitchOS
        """
        return self._os
    ...
    @os.setter
    def os(self, os):
        """Sets the os of this V1SwitchUpdateRequest.

        the operating system the switch currently has  # noqa: E501

        :param os: The os of this V1SwitchUpdateRequest.  # noqa: E501
        :type: V1SwitchOS
        """
