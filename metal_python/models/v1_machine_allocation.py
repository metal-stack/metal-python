...
class V1MachineAllocation(object):
    ...
    def __init__(self, boot_info=None, created=None, description=None, filesystemlayout=None, hostname=None, image=None, name=None, networks=None, project=None, reinstall=None, ssh_pub_keys=None, succeeded=None, user_data=None):  # noqa: E501
