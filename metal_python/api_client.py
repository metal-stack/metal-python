...
<<<<<<< master
        self.user_agent = 'Swagger-Codegen/v0.24.4/python'
=======
        self.user_agent = 'Swagger-Codegen/v0.24.5/python'
>>>>>>> Bump to version v0.24.5
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(metal_python.models, klass)
